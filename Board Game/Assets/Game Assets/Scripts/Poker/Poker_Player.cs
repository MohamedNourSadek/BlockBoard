    ...
    IEnumerator WhoWon()
    {
        ...
        if (PlayersInRound.Count > 1)
        {
            ...
            foreach (var p in player_score)
            {
                ...
                DebugManager.Instance.Log((identity)p.Key + " has value " + p.Value.Value + ", Backup of " + p.Value.BackUp_Value);
            }
        }
        else if(PlayersInRound.Count == 1)
        {
        ...
        else if(winners.Count == 0)
        {
            ...
            foreach (var player in Cross_Scene_Data.players)
                Get_Player(player.Key.Identity).myChips += (Final_bet / Cross_Scene_Data.players.Count);
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyDown("y"))
        {
            if (Is_Royal_Flush(test_cards).Is_True)
            {
                ...
                DebugManager.Instance.Log("It's a Royal Flush With Value of " + myValue.Value + " , And Backup Of " + myValue.BackUp_Value);
            }
            else if (Is_Straight_Flush(test_cards).Is_True)
            {
                ...
                DebugManager.Instance.Log("It's a Straight Flush With Value of " + myValue.Value + " , And Backup Of " + myValue.BackUp_Value);
            }
            else if (Four_of_AKind(test_cards).Is_True)
            {
                ...
                DebugManager.Instance.Log("It's a Four of A kind With Value of " + myValue.Value + " , And Backup Of " + myValue.BackUp_Value);
            }
            else if (IsFullHouse(test_cards).Is_True)
            {
                ...
                DebugManager.Instance.Log("It's a Full House With a Value of " + myValue.Value + " , And Backup Of " + myValue.BackUp_Value);
            }
            else if (Is_Flush(test_cards).Is_True)
            {
                ...
                DebugManager.Instance.Log("It's a Flush With Value of " + myValue.Value + " , And Backup Of " + myValue.BackUp_Value);
            }
            else if (Is_Straight(test_cards).Is_True)
            {
                ...
                DebugManager.Instance.Log("It's a Straight With Value of " + myValue.Value + " , And Backup Of " + myValue.BackUp_Value);
            }
            else if (Is_Three_OfAkind(test_cards).Is_True)
            {
                ...
                DebugManager.Instance.Log("It's a Three of a kind with Value of " + myValue.Value + " , And Backup Of " + myValue.BackUp_Value);
            }
            else if (Is_TwoPairs(test_cards).Is_True)
            {
                ...
                DebugManager.Instance.Log("It's a Two Pair With Value of " + myValue.Value + " , And Backup Of " + myValue.BackUp_Value);
            }
            else if (Is_One_Pair(test_cards).Is_True)
            {
                ...
                DebugManager.Instance.Log("It's a One pair With Value of " + myValue.Value + " , And Backup Of " + myValue.BackUp_Value);
            }
            else
            {
                myValue.Value = 0f;
                ...
                DebugManager.Instance.Log("It's a high card with Value of " + myValue.Value + " , And Backup Of " + myValue.BackUp_Value);
            }
        }
